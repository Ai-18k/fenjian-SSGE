...
class DepthFirstBufferPacker:
    ...
    def __init__(self, spec: str, buffer_capacity: int, *, verbose: bool = False):
        ...
        self.buffer: list[BufferFish] = []
        self.cartons: list[BoxRecord] = []
        self.overflow: list[BufferFish] = []
        self.steps: list[PackStep] = []
        self._next_id = 1
